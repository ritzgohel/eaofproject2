    ...
    <table align="center" style="  font-family: 'Arial Rounded MT Bold'; font-size: medium; font-weight: bold; font-style: normal; font-variant: normal; background-color: aliceblue">
        ...
        <%--    <tr>
            ...
            <tr>
                ...
                <td style="height: 60px"><asp:DropDownList ID="ddldistrict" runat="server" AutoPostBack = "true" OnSelectedIndexChanged = "district_Changed"  Height="28px" Width="334px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td style="height: 61px">
                    <asp:DropDownList ID="ddltaluka" runat="server" AutoPostBack = "true" OnSelectedIndexChanged = "taluka_Changed"  Height="28px" Width="334px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td style="height: 60px">
                    <asp:DropDownList ID="ddlvillages" runat="server"  Height="28px" Width="334px">
                    </asp:DropDownList>
                </td>
            </tr>
         <tr>
...
&nbsp;&nbsp;&nbsp; Password:</td>
            <td style="width: 486px">
              ...
              <tr>
            <td align="center" style="width: 859px"><asp:Button ID="btnsubmit" runat="server" Text="Submit" BackColor="#ffffcc" Width="94px" ForeColor="black" Height="49px" OnClick="btnsubmit_Click" /></td>
            <td style="width: 486px"><asp:Button ID="btncancel" runat="server" Text="Cancel" BackColor="#ffcccc" Width="94px" ForeColor="black" Height="50px" OnClick="btncancel_Click"  /></td>        
