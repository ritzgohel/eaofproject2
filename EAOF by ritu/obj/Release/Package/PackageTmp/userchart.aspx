<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="userchart.aspx.cs" Inherits="EAOF_by_ritu.userchart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <asp:BarChart ID="BarChart1" runat="server"></asp:BarChart>
</asp:Content>
